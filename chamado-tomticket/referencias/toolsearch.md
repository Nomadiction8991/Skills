...
```bash
ToolSearch(query: "select:mcp__tomticket__ver_chamado,mcp__tomticket__comentar_chamado,mcp__tomticket__criar_chamado,mcp__tomticket__editar_chamado,mcp__tomticket__transferir_chamado,mcp__tomticket__buscar_cliente,mcp__tomticket__listar_departamentos,mcp__tomticket__listar_categorias,mcp__tomticket__listar_operadores,mcp__tomticket__listar_status,mcp__tomticket__listar_chamados,mcp__gitlab__list_merge_requests,mcp__gitlab__get_merge_request")
```
